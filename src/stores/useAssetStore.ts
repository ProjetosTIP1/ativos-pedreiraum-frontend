...
export const useAssetStore = create<AssetStore>((set, get) => ({
    ...
    fetchAssets: async (params) => {
        ...
        try {
            ...
            set({ error: error instanceof Error ? error.message : 'Falha ao buscar ativos', isLoading: false });
        }
    },
    ...
    fetchHighlights: async () => {
        ...
        try {
            ...
            set({ error: error instanceof Error ? error.message : 'Falha ao buscar destaques', isLoading: false });
        }
    },
    ...
    fetchAssetBySlug: async (slug: string) => {
        ...
        try {
            ...
            set({ error: error instanceof Error ? error.message : 'Falha ao buscar detalhes do ativo', isLoading: false });
        }
    },
    ...
    createAsset: async (asset: Partial<Asset>) => {
        ...
        try {
            ...
            const msg = error instanceof Error ? error.message : 'Erro ao criar ativo';
    ...
    updateAsset: async (id: string, asset: Partial<Asset>) => {
        ...
        try {
            ...
            const msg = error instanceof Error ? error.message : 'Erro ao atualizar ativo';
            set({ error: msg, isLoading: false });
            throw error;
        }
    },
    ...
    deleteAsset: async (id: string) => {
        ...
        try {
            ...
            const msg = error instanceof Error ? error.message : 'Erro ao excluir ativo';
            set({ error: msg, isLoading: false });
            throw error;
        }
    }
