...
export const AssetFilters: React.FC = () => {
    ...
    const categories = [
        ...
        { value: "EXCAVATORS", label: "Escavadeiras" },
        { value: "CRUSHERS", label: "Britadores" },
        { value: "GRADERS", label: "Motoniveladoras" },
        { value: "PLANT", label: "Equip. de Planta" },
        ...
        <div className={style.sidebar}>
            ...
            <div className={style.filterGroupWide}>
                ...
                <div className={style.yearRange}>
                    <input 
                        ...
                        onChange={(e) => setFilters({ min_year: parseInt(e.target.value) || undefined })}
                    ...
                    <input 
                        ...
                        onChange={(e) => setFilters({ max_year: parseInt(e.target.value) || undefined })}
                        className={style.yearInput}
                    />
                </div>
            </div>
            ...
            <div className={style.footer}>
                <p className={style.footerText}>
                    Mostrando resultados dinâmicos conforme seleção. Os ativos são atualizados em tempo real.
                </p>
            </div>
        </div>
    );
